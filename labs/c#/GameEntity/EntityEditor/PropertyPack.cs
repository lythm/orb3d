...
namespace EntityEditor.PropertyPack
{
	/// <summary>
	...
	/// </summary>
	public class PropertyPack : ICustomTypeDescriptor
	{
		...
		{
			private PropertyPack bag;
			private PropertySpec item;

			public PropertySpecDescriptor(PropertySpec item, PropertyPack bag, string name, Attribute[] attrs) :
				base(name, attrs)
			{
				this.bag = bag;
				this.item = item;
	...
	/// </summary>
	public class PropertyTable : PropertyPack
	{
