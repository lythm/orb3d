...
BEGIN_MESSAGE_MAP(CGameEditorApp, CWinAppEx)
...
// CGameEditorApp 自定义加载/保存方法

void CGameEditorApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CGameEditorApp::SaveCustomState()
{
}
