...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_TestForm_t, stringdata) + ofs \
...
const QMetaObject TestForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TestForm.data,
      qt_meta_data_TestForm,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TestForm.stringdata))
        return static_cast<void*>(const_cast< TestForm*>(this));
    if (!strcmp(_clname, "Ui::TestForm"))
        return static_cast< Ui::TestForm*>(const_cast< TestForm*>(this));
